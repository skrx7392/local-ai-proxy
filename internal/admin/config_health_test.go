...
func defaultSnap() ConfigSnapshot {
	return ConfigSnapshot{
		...
		AuthLoginRateLimitPerMinute:      5,
		AuthLoginEmailRateLimitPerMinute: 5,
		AuthRegisterRateLimitPerMinute:   3,
		AuthGeneralRateLimitPerMinute:    120,
		AuthBcryptMaxConcurrent:          8,
...
func TestConfig_ReturnsWhitelistedFields(t *testing.T) {
	...
	expected := map[string]any{
		...
		"max_json_request_body_bytes":            float64(snap.MaxJSONBodyBytes),
		...
		"auth_login_rate_limit_per_minute":       float64(snap.AuthLoginRateLimitPerMinute),
		"auth_login_email_rate_limit_per_minute": float64(snap.AuthLoginEmailRateLimitPerMinute),
		"auth_register_rate_limit_per_minute":    float64(snap.AuthRegisterRateLimitPerMinute),
		"auth_general_rate_limit_per_minute":     float64(snap.AuthGeneralRateLimitPerMinute),
		"auth_bcrypt_max_concurrent":             float64(snap.AuthBcryptMaxConcurrent),
